...
//********************************
    ...
    //the first half of the "this" is sorted recursively, then the second half of
    //the "this" is sorted recursively, and then the two halves are merged together
    ...
    //takes a sorted list "that" and merges it with "this" which must also already be sorted
    //note that I cast this.head() and that.head() to Comparable, which shouldn't be
    //a problem, because the only method to call this method is sort(), and no one would
    //call sort() on a list of Objects that don't implement the Comparable interface
    ...
    //returns an ImmutableList containing the first n elements of "this"
    ...
    //returns an ImmutableList containing all elements of "this" that come after the first n elements
